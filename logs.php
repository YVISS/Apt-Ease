        ...
        <div class="wrapper-container">
            ...
            <div class="main-content">
                <div class="page-title">
                    <h1>Logs</h1>
                    <p>View all system logs below</p>
                </div>
                ...
                <div class="table_component">
                    ...
                    function buildTable($result)
                    {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<tr class='cells'>";
                                echo "<td class='items'>" . htmlspecialchars($row['datelog']) . "</td>";
                                echo "<td class='items'>" . htmlspecialchars($row['timelog']) . "</td>";
                                echo "<td class='items'>" . htmlspecialchars($row['action']) . "</td>";
                                echo "<td class='items'>" . htmlspecialchars($row['module']) . "</td>";
                                echo "<td class='items'>" . htmlspecialchars($row['ID']) . "</td>";
                                echo "<td class='items'>" . htmlspecialchars($row['performedby']) . "</td>";
                                echo "</tr>";
                            }
                            echo "</table>";
                            echo "</div>";
                    ...
                    // Fetch logs based on search or refresh
