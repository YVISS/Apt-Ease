...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2025 at 12:16 PM
...
('Tenant1', '12345', 'TENANT', 'trylandlord', '04/22/2025'),
...
('22/04/2025', '03:14:02pm', 'Create', 'Accounts Management', 'Tenant1', 'trylandlord'),
('04/22/2025', '03:14:23', 'Update', 'Accounts Management', 'Tenant1', 'trylandlord'),
('22/04/2025', '03:14:57pm', 'Add', 'Tenants Management', '01A', 'trylandlord');
...
--
-- Table structure for table `tblmaintenancelogs`
--
...
CREATE TABLE `tblmaintenancelogs` (
  ...
  `dateConfirmed` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `tblmaintenancelogs`
--

INSERT INTO `tblmaintenancelogs` (`ticketID`, `username`, `description`, `dateSubmitted`, `dateConfirmed`) VALUES
('002', 'Tenant1', 'pakyu al', '2025-04-22 16:42:33', '2025-04-24 16:06:23'),
('001', 'AptEase001', 'ang asim mo 002', '2025-03-21 00:04:34', '2025-04-24 16:07:21'),
('1', 'AptEase001', 'namo dan', '2025-04-24 17:33:08', '2025-04-24 17:33:50'),
('001', 'AptEase001', 'namo dan', '2025-04-24 17:33:08', '2025-04-24 17:34:41'),
('001', 'AptEase001', 'namo dan', '2025-04-24 17:33:08', '2025-04-24 17:34:46'),
('001', 'AptEase001', 'namo dan', '2025-04-24 17:33:08', '2025-04-24 17:35:42'),
('001', 'AptEase002', 'ewan', '2025-04-24 17:44:04', '2025-04-24 17:44:13'),
('001', 'AptEase001', 'ewan', '2025-04-24 17:43:53', '2025-04-24 18:07:23'),
('001', 'AptEase001', 'yuiguygb', '2025-04-24 18:12:24', '2025-04-24 18:12:37');
...
('AptEase001', '1234567', 'GCash', '2025-03-21 20:47:44', 'Confirmed'),
('AptEase001', '1234', 'Bank', '2025-03-21 20:47:55', 'Confirmed'),
('AptEase002', '123', 'GCash', '2025-03-21 20:48:04', 'Confirmed'),
('AptEase002', '12345567', 'Bank', '2025-03-21 20:48:09', 'Confirmed'),
('trylandlord', '10000', 'GCash', '2025-04-20 23:51:16', 'Confirmed'),
('trytenant', '2000', 'Bank', '2025-04-21 22:55:30', 'Confirmed'),
('trytenant', '0', 'Bank', '2025-04-21 23:08:02', 'Confirmed'),
('Tenant1', '1000', 'GCash', '2025-04-22 15:15:32', 'Confirmed');

-- --------------------------------------------------------

--
-- Table structure for table `tblpaymentslogs`
--

CREATE TABLE `tblpaymentslogs` (
  `username` varchar(50) NOT NULL,
  `amount` varchar(30) NOT NULL,
...
--
-- Dumping data for table `tblpaymentslogs`
--

INSERT INTO `tblpaymentslogs` (`username`, `amount`, `paymentmethod`, `date`, `status`) VALUES
('', '1000', 'Gcash', '04/22/2025', ''),
('', '123123123', 'Bank', '2025-04-22 16:16:10', 'Confirmed'),
('Tenant1', '123123', 'GCash', '2025-04-22 16:42:11', 'Confirmed'),
('Tenant1', '234234', 'GCash', '2025-04-22 16:46:24', 'Confirmed'),
('Tenant1', '123123123123123', 'Bank', '2025-04-22 16:46:09', 'Confirmed');
...
('01A', 'Amos', 'Asilo', 'Ombac', '09912314123', 'YES', 'trylandlord', '04/22/2025', 'Tenant1');
